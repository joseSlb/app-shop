...
<div class="main main-raised">
    <div class="container">
        ...
        <div class="section">
            ...
            <!-- esto es para poder mostrar los errores de validacion: -->
            @if ($errors->any())
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group label-floating">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ old('name', $product->name) }}"> <!-- muestra EL valor anterior en old -->
                        </div>
                    </div>
